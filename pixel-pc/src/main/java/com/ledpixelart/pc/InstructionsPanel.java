...
public class InstructionsPanel extends JPanel
{
	...
	String developmentHtml = "<html><body>" + "IMPORTANT: You must first Bluetooth pair or USB connect PIXEL to your device.<br/><br/>Move the toggle switch on PIXEL to the 'PC USB' position if connecting wtih USB or leave selected on 'Bluetooth' (default) for Bluetooth connections.<br/><br/>PIXEL will show up in Bluetooth settings as “PIXEL”, use pairing code 0000 or 4545 if you have a PIXEL V1 frame.<br/><br/>If this application does not find PIXEL: power off and on, Bluetooth pair again, and then re-run this application.<br/><br/>Click to stream GIFs and images or double click to write them for stand alone mode operation (only PIXEL V2 frames can write). <br/><br/>IMPORTANT: When double clicking to write, let the write fully finish before clicking somewhere else. <br/><br/>More info at http://ledpixelart.com" + "</body></html>";
