    ...
    public void setById(int id)
    {
        switch (id)
        {
            ...
            case 17:
                ...
                break;	 
            case 18:
            	LED_MATRIX = ioio.lib.api.RgbLedMatrix.Matrix.ADAFRUIT_64x32_MIRRORED;
                frame_length = 8192;
                ...
                break;	 
            case 19:
            	LED_MATRIX = ioio.lib.api.RgbLedMatrix.Matrix.ADAFRUIT_256x16;
                frame_length = 8192;
                currentResolution = 25616; 
                break;	
            case 20:
            	LED_MATRIX = ioio.lib.api.RgbLedMatrix.Matrix.ADAFRUIT_32x32_MIRRORED;
                frame_length = 4096;
                currentResolution = 64999; //had to make unique
                break;	
            case 21:
            	LED_MATRIX = ioio.lib.api.RgbLedMatrix.Matrix.ADAFRUIT_32x32_4X_MIRRORED;
                frame_length = 8192;
                currentResolution = 128; 
                break;	
            case 22:
            	LED_MATRIX = ioio.lib.api.RgbLedMatrix.Matrix.ADAFRUIT_128x16;
                frame_length = 4096;
                currentResolution = 12816; 
                break;	
            case 23:
            	LED_MATRIX = ioio.lib.api.RgbLedMatrix.Matrix.ALIEXPRESS_RANDOM1_32x32;
                frame_length = 2048;
                currentResolution = 32; 
                break;	
            case 24:
            	LED_MATRIX = ioio.lib.api.RgbLedMatrix.Matrix.ADAFRUIT_64x32_ColorSwap;
                frame_length = 4096;
                currentResolution = 64; 
                break;	
            case 25:
            	LED_MATRIX = ioio.lib.api.RgbLedMatrix.Matrix.ADAFRUIT_64x64_ColorSwap;
                frame_length = 8192;
                currentResolution = 128; 
                break;
            case 26:
